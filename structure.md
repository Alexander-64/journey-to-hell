...
Основное, это длинный цикл обратной связи от коллег из тестирования по релизу. Тестировщики привлекались только после отгрузки релиза. Как минимум, можно было предварительно тестировать и на стенде разработчиков, если задача уже прошла ревью и смержена в девелоп.
